...
proc fpga_ddr3_p0_perform_flexible_read_capture_timing_analysis {opcs opcname inst family scale_factors_name io_std interface_type max_package_skew dqs_phase period all_dq_pins pin_array_name timing_parameters_array_name summary_name MP_name IP_name board_name fpga_name} {
	...
	if {$IP(read_deskew_mode) == "dynamic"} {
		...
		# Consider variation in the delay chains used during dynamic deksew
		set dqs_period [ fpga_ddr3_p0_get_dqs_period $pins(dqs_pins) ]
		set offset_from_90 [fpga_ddr3_p0_get_acv_read_offset $period $dqs_phase $dqs_period]
		if {$IP(num_ranks) == 1} {
...
proc fpga_ddr3_p0_perform_ac_analyses {opcs opcname inst scale_factors_name pin_array_name timing_parameters_array_name summary_name IP_name} {
	...
	foreach ac_pin $ac_pins {
		...
		set ac_clk_phase_select_node [fpga_ddr3_p0_traverse_to_clock_phase_select $ac_pin msg_list]
		...
		set extra_ccpr [fpga_ddr3_p0_round_3dp [expr ($clk_max - $clk_min + $ac_max - $ac_min)/2.0]]
