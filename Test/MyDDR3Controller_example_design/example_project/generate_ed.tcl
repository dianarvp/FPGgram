...
lappend arg_list "--report-file=csv:MyDDR3Controller_example.csv"
lappend arg_list "--report-file=qip:MyDDR3Controller_example.qip"
lappend arg_list "--output-name=MyDDR3Controller_example"
...
lappend arg_list "--component-param=MEM_TRFC_NS=260.0"
...
lappend arg_list "--component-param=MEM_VERBOSE=false"
...
lappend arg_list "--component-param=TIMING_TDS=125"
...
lappend arg_list "--component-param=TIMING_TIS=350"
lappend arg_list "--component-param=TIMING_TQH=0.38"
lappend arg_list "--component-param=TIMING_TQSH=0.25"
...
catch { eval [concat [list exec "/home/diana/altera_lite/15.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr3_tg_ed] $arg_list] } temp
puts $temp
