...
entity MyDDR3Controller_0002 is
	port (
...
end entity MyDDR3Controller_0002;

architecture rtl of MyDDR3Controller_0002 is
	component MyDDR3Controller_pll0 is
		port (
	...
	end component MyDDR3Controller_pll0;

	component MyDDR3Controller_p0 is
		port (
			global_reset_n              : in    std_logic                     := 'X';             -- reset_n
	...
	end component MyDDR3Controller_p0;
	...
	component MyDDR3Controller_s0 is
		port (
	...
	end component MyDDR3Controller_s0;

	component MyDDR3Controller_c0 is
		port (
			afi_reset_n         : in  std_logic                     := 'X';             -- reset_n
			afi_clk             : in  std_logic                     := 'X';             -- clk
			afi_half_clk        : in  std_logic                     := 'X';             -- clk
	...
	end component MyDDR3Controller_c0;
...
begin
	...
	pll0 : component MyDDR3Controller_pll0
		port map (
	...
	p0 : component MyDDR3Controller_p0
		port map (
			global_reset_n              => global_reset_n,                              --        global_reset.reset_n
	...
	s0 : component MyDDR3Controller_s0
		port map (
			avl_clk                     => p0_avl_clk_clk,                     --          avl_clk.clk
			avl_reset_n                 => p0_avl_reset_reset,                 --        avl_reset.reset_n
			scc_clk                     => p0_scc_clk_clk,                     --          scc_clk.clk
	...
	c0 : component MyDDR3Controller_c0
		port map (
			afi_reset_n         => p0_afi_reset_reset,         --    afi_reset.reset_n
			afi_clk             => pll0_afi_clk_clk,           --      afi_clk.clk
			afi_half_clk        => pll0_afi_half_clk_clk,      -- afi_half_clk.clk
...
end architecture rtl; -- of MyDDR3Controller_0002
