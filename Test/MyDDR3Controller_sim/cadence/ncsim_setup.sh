...
TOP_LEVEL_NAME="MyDDR3Controller"
QSYS_SIMDIR="./../"
...
mkdir -p ./libraries/MyDDR3Controller/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_pll0.vho"           -work pll0             -cdslib ./cds_libs/pll0.cds.lib            
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_pll0_sim_delay.vhd" -work pll0             -cdslib ./cds_libs/pll0.cds.lib            
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_0002.vhd"           -work MyDDR3Controller -cdslib ./cds_libs/MyDDR3Controller.cds.lib
  ncvhdl -v93 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller.vhd"                                                                                                   
fi
