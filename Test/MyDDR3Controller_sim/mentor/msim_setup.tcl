...
# # End of template
# ----------------------------------------
# If MyDDR3Controller is one of several IP cores in your
...
# ----------------------------------------
# ACDS 15.1 193 linux 2016.04.13.06:10:01
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "MyDDR3Controller"
}
...
ensure_lib                  ./libraries/MyDDR3Controller/
vmap       MyDDR3Controller ./libraries/MyDDR3Controller/
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_pll0.vho"           -work pll0            
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_pll0_sim_delay.vhd" -work pll0            
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_0002.vhd"           -work MyDDR3Controller
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller.vhd"                                                       
}
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L pll0 -L MyDDR3Controller -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L pll0 -L MyDDR3Controller -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L cyclonev $TOP_LEVEL_NAME
}
