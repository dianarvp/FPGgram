...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_pll0.vho"           -work pll0            
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_pll0_sim_delay.vhd" -work pll0            
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller/MyDDR3Controller_0002.vhd"           -work MyDDR3Controller
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/MyDDR3Controller.vhd"                                                       
fi
